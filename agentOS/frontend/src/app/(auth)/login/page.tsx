...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen">
      {/* Left — decorative panel matching landing page aesthetic */}
      <div className="relative hidden w-1/2 overflow-hidden border-r border-[#e2e2e2] bg-white lg:block">
        ...
        {/* Purple blocks */}
        <div className="absolute bottom-0 left-0 right-0 top-0 flex items-end justify-start p-[90px]">
      ...
      <div className="flex flex-1 items-center justify-center bg-white px-8">
        <div className="w-full max-w-[380px]">
          ...
          <form onSubmit={handleLogin} className="flex flex-col gap-4">
            ...
            <div>
              <div className="flex items-center justify-between">
                ...
                <Link href="#" className="text-xs font-medium text-[#9d66ff] hover:underline">
                  Forgot password?
                </Link>
              </div>
              <input
          ...
          <p className="mt-6 text-center text-sm text-[#4d4d4d]">
            ...
            <Link href="/signup" className="font-medium text-[#9d66ff] hover:underline">
              Sign up
            </Link>
          </p>
        </div>
